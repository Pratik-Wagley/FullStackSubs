...
public class UserInterface {
    ...
    // Removed initial sandwich object, as it will be created dynamically
    ...
    public void addSandwich() {
        ...
        Sandwich sandwich = new Sandwich(size, bread, new ArrayList<>(), true);
        ...
        if (userInput == 1) {
            sandwiches.add(sandwich); // Add the sandwich to the list
            order.setSandwiches(sandwiches); // Update the order
            addSandwich(); // Start a new sandwich
        } else if (userInput == 2) {
            sandwiches.add(sandwich); // Add the sandwich to the list
            order.setSandwiches(sandwiches); // Update the order
        } else {
        ...
        while (addingChips) {
            ...
            if (chipsOfChoice == 6) {
                ...
                switch (chipsOfChoice) {
                    case 1: chipsName = "Potato Chips"; break;
                    case 2: chipsName = "Doritos Chips"; break;
                    case 3: chipsName = "Pita Chips"; break;
                    case 4: chipsName = "Veggie Chips"; break;
                    case 5: chipsName = "Pretzels"; break;
                    default:
                        System.out.println("Invalid choice. Please try again.");
                        continue;
                }
